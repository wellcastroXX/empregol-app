      ...
      >
        ...
        <View style={styles.grid}>
          <RoleCard
            token=""
            name="Atleta"
            hint="Tenho minutos pra mostrar."
            active={role === "atleta"}
          ...
          <RoleCard
            token=""
            name="Contratante"
            hint="Procuro talento esquecido."
            active={role === "contratante"}
          ...
          <View style={styles.subSection}>
            ...
            <View style={styles.grid}>
              ...
              <RoleCard
                token="R."
                name="Agente"
                hint="Procurador / empresário."
                active={sub === "agent"}
                onPress={() => setSub("agent")}
              />
            </View>
          </View>
        )}
...
function RoleCard({
  ...
  return (
    <Pressable
      ...
      style={[
        styles.roleCard,
        active ? styles.roleActive : styles.roleInactive,
      ]}
    >
      <Text
        style={styles.roleToken}
